...
class MOSSv1d5VisionConfig(PretrainedConfig):
    model_type = "moss_v1d5_vision"
...
class MOSSv1d5TextConfig(PretrainedConfig):
    model_type = "moss_v1d5_text"
...
class MOSSv1d5Config(PretrainedConfig):
    model_type = "moss_v1d5"
    sub_configs = {
        "encoder_config": MOSSv1d5VisionConfig,
        "decoder_config": MOSSv1d5TextConfig,
    }
